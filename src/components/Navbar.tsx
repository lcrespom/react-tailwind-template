  ...
  return (
    <label className="swap swap-rotate" aria-label="Toggle theme">
      ...
      <svg
        ...
        viewBox="0 0 24 24"
      >
        <path d="M21.64,13a1,1,0,0,0-1.05-.14,8.05,8.05,0,0,1-3.37.73A8.15,8.15,0,0,1,9.08,5.49a8.59,8.59,0,0,1,.25-2A1,1,0,0,0,8,2.36,10.14,10.14,0,1,0,22,14.05,1,1,0,0,0,21.64,13ZM14,20A8,8,0,0,1,6.36,5.83a10.16,10.16,0,0,0,10.81,10.8A8,8,0,0,1,14,20Z" />
      </svg>
    </label>
  )
}
